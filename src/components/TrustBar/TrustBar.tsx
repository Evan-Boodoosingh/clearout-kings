...
const trustItems = [
  {
    id: 1,
    icon: ShieldCheck,
    title: "Your Valuables Stay Safe",
    description:
      "Careful, respectful crews who treat your belongings like their own. Licensed and insured for your peace of mind.",
  },
  {
    id: 2,
    icon: Receipt,
    ...
    description:
      "You'll know exactly what you're paying before we start. Free estimates, no hidden fees, pay after the job is done.",
  },
  {
    id: 3,
    icon: Clock,
    title: "Fast. Same-Day Available.",
    description:
      "Most jobs are completed in a single day. Same-day and next-day service available across greater Boston.",
  },
];
    ...
    <section id="trust" className="relative py-24 px-6">
      ...
      >
        <div className="flex items-center justify-center gap-4 mb-4">
          ...
          />
          <span className="text-md tracking-widest uppercase text-white">
            The Promise
          </span>
          <div
            className="h-px w-12"
        ...
        >
          Why Homeowners Choose <span style={{ color: siteConfig.theme.accentColor }} >Clearout Kings</span>
        </h2>
      </motion.div>
