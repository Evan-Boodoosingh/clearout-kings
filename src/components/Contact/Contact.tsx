...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative py-24 px-6 overflow-hidden">
      ...
      <motion.div className="relative z-10 max-w-5xl mx-auto overflow-hidden rounded-3xl bg-center bg-[length:600px] md:bg-cover" variants={blockVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-80px" }} style={{ backgroundImage: "url(/assets/cardboard-texture.jpg)" }}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div className="flex flex-col gap-8 order-2 lg:order-1">
              ...
              <div className="flex flex-col gap-5">
                <a href={"tel:" + siteConfig.business.phone.replace(/[^0-9]/g, "")} className="flex items-center gap-4 no-underline group">
                  <div className="w-10 h-10 rounded-xl flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform duration-200" style={{ background: siteConfig.theme.accentColor + "15", border: "1px solid " + siteConfig.theme.accentColor + "30" }}><Phone size={16} style={{ color: siteConfig.theme.accentColor }} /></div>
                ...
                <a href={"mailto:" + siteConfig.business.email} className="flex items-center gap-4 no-underline group">
                  <div className="w-10 h-10 rounded-xl flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform duration-200" style={{ background: siteConfig.theme.accentColor + "15", border: "1px solid " + siteConfig.theme.accentColor + "30" }}><Mail size={16} style={{ color: siteConfig.theme.accentColor }} /></div>
                ...
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 rounded-xl flex items-center justify-center shrink-0" style={{ background: siteConfig.theme.accentColor + "15", border: "1px solid " + siteConfig.theme.accentColor + "30" }}><MapPin size={16} style={{ color: siteConfig.theme.accentColor }} /></div>
                ...
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 rounded-xl flex items-center justify-center shrink-0" style={{ background: siteConfig.theme.accentColor + "15", border: "1px solid " + siteConfig.theme.accentColor + "30" }}><Clock size={16} style={{ color: siteConfig.theme.accentColor }} /></div>
            ...
            {submitted ? (
              <div className="flex flex-col items-center justify-center text-center gap-4 py-12">
                <div className="w-16 h-16 rounded-full flex items-center justify-center" style={{ background: siteConfig.theme.accentColor + "20", border: "1px solid " + siteConfig.theme.accentColor }}><span style={{ color: siteConfig.theme.accentColor }} className="text-2xl">&#10003;</span></div>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4 order-1 lg:order-2">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <select name="service" value={formData.service} onChange={handleChange} required className="rounded-xl px-4 py-3 text-sm text-white outline-none transition-all duration-200" style={{ background: "rgba(0,0,0,0.4)", border: "1px solid rgba(255,255,255,0.12)" }}>
                    ...
                    <option value="basement" style={{ background: "#1a1a1a" }}>Basement Cleanout</option>
                    <option value="junk" style={{ background: "#1a1a1a" }}>Junk and Furniture Removal</option>
